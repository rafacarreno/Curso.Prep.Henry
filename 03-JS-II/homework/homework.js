...
function saludo(idioma) { if (idioma==='aleman'){
  return'Guten Tag!';} else if (idioma==='mandarin') {
    return'Ni Hao!';} else if (idioma==='ingles') {
      return'Hello!';} else {
        return'Hola!';}
...
function fizzBuzz(numero) {
    if (numero % 3 === 0 && numero % 5 === 0) {return 'fizzbuzz';} else if (numero % 3 === 0) {
    return 'fizz';} else if (numero % 5 === 0) {
...
function esPrimo(numero) {
  ...
  for (let i = 1; i <= numero; i++) {
    if (numero % i === 0) {cuentaDivisor = (cuentaDivisor + 1);}
  }
    if (cuentaDivisor === 2) {return true;} else {return false;}
