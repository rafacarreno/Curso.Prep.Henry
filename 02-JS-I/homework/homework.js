...
const nuevaString = 'Hola, ¿Cómo estas?';
...
function esPositivo(numero) {
  ...
  if (numero > 0) {return 'Es positivo';} else if (numero < 0){return 'Es negativo';}{return false;}} //puede llevar else if como no!
